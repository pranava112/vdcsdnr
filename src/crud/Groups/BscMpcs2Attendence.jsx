...
const BscMpcs2Attendence = () => {
  const {
    ...
    handleSubmit,
    calculatePercentage,
  } = useAttendanceDatampcs(2);

  return (
    <>
      <AsideBar />
      <section id="table-back" className="p-4 bg-gray-100 min-h-screen">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">BSC-MPCS Year-2 Attendance Sheet</h1>
        <AttendanceTable
          users={users}
...
export default memo(BscMpcs2Attendence);
